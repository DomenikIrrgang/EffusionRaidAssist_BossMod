...
function EffusionRaidAssistBossMod:GetOptions()
    return {
        ...
        timer_width = {
            ...
            type = "range",
            name = "Width",
            get = function() return self:GetData("timer.width") end,
            set = function(_, value) self:ChangeData("timer.width", value) end,
            step = 1,
            min = 100,
            max = 500,
            width = "full"
        ...
        timer_height = {
            ...
            type = "range",
            name = "Height",
            get = function() return self:GetData("timer.height") end,
            set = function(_, value) self:ChangeData("timer.height", value) end,
            step = 1,
            min = 15,
            max = 50,
            width = "full"
